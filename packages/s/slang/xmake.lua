package("slang")
    ...
    add_versions("vulkan-sdk-1.4.350.0", "d88cc8fff35baf96cf30d242b2572564cf8043b6")
    ...
    add_configs("slang_rhi", { description = "Enable slang-rhi as dependency", default = false, type = "boolean" })
    ...
    on_install("windows|x64", "macosx", "linux|x86_64", function (package)
        ...
        table.insert(configs, "-DSLANG_ENABLE_SLANG_RHI=" .. (package:config("slang_rhi") and "ON" or "OFF"))
